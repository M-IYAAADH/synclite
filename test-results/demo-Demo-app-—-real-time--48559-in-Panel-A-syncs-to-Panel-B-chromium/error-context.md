...
- Name: demo.spec.ts >> Demo app — real-time sync >> typing in Panel A syncs to Panel B
- Location: tests/demo.spec.ts:10:7
    ...
    - main [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]:
          ...
          - textbox "Start typing… changes appear in the other window in real time." [active] [ref=e29]: hello from panel A
          - generic [ref=e31]: 18 chars
        - generic [ref=e32]:
          - generic [ref=e33]:
