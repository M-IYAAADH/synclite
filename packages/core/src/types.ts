/** Status of the NexSync connection to the relay. */
...
export type Operation = {
  ...
  deviceId: string
  /** Optional user identifier passed in NexSyncConfig */
  userId?: string
  /** True once the relay has confirmed receipt */
  synced: boolean
}

/** Configuration passed to `new NexSync(config)` */
export type NexSyncConfig = {
